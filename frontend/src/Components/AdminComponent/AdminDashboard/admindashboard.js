            ...
            <div className="row admindash">
                <div className="col-2 bgColor text-center  menu">
                    ...
                    <div className="text-center">
                        ...
                        <Link to={'/dashboard/usermgmt/role'} className='row text-decoration-none text-center text-white'>
                            <p className='n'>User Registration</p>
                        </Link>
                        <Link to={'/admin/sellermgmt'} className='row text-decoration-none text-center text-white'>
                            <p className='n'>Manage Seller</p>
                        </Link>
                        <Link to={'/admin/buyermgmt'} className='row text-decoration-none text-center text-white'>
                            <p className='n'>Manage Buyer</p>
                        </Link>
                        <Link to={'/admin/enquiry'} className='row text-decoration-none text-center text-white'>
