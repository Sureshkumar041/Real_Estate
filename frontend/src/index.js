...
root.render(
  <BrowserRouter>
    <Routes>
      ...
      <Route path='/realestate/homepage' element={<Header />} />
      ...
      <Route path='/realestate/showproperty/:id' element={<ViewProperty />} />
      <Route path='/realestate/user/unknowprofile/:userId' element={<ViewProfile />} />
      <Route path='/realestate/user/sendotp' element={<SendOtp />} />
      <Route path='/realestate/user/verifyotp/:userId' element={<VerifyOtp />} />
      <Route path='/realestate/user/newpassword/:userId' element={<NewPassword />} />


      <Route path='/realestate/propertyenquiry' element={<ReceiveEnquiry />} />
      <Route path='/realestate/viewproperty' element={<ShowPropsDetails />} />
      <Route path='/realestate/user/viewprofile' element={<AddDetails />} />
      <Route path='/realestate/user/editprofile' element={<EditUserProfile />} />
      <Route path='/realestate/user/changepassword' element={<ChangePassword />} />
      <Route path='/realestate/dashboard/notifications' element={<Notifications />} />
      <Route path='/realestate/admin/propsenquiry/:propsId' element={<PropertyEnquiries />} />
      ...
      <Route path='/realestate/propertyenquiry/:id' element={<PropertyEnquiry />} />
      <Route path='/realestate/seller/updateproperty' element={<UpdateProp />} />
      <Route path='/realestate/seller/editproperty/:id' element={<Start />} />
      <Route path='/realestate/seller/propsenquiries/:senderId' element={<PropsEnquires />} />
      ...
      <Route path='/realestate/admin/buyermgmt' element={<AdminBuyerMgmt />} />
      <Route path='/realestate/admin/enquiry' element={<AdminPropertyEnquiry />} />
      <Route path='/realestate/dashboard/usermgmt/:role' element={<UserMgmt />} />
    </Routes>
  </BrowserRouter>
);
